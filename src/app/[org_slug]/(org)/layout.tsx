...
// Chrome de la organización (barra lateral). Solo envuelve las páginas de org
// — dashboard, miembros, crear proyecto —; las pantallas de proyecto viven
// fuera de este grupo y no lo cargan.
