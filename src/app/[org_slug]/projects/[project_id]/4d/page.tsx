...
import { CalendarDays, Monitor, Settings2, Loader2, GripHorizontal, Link2, Layers } from 'lucide-react';
...
export default function FourDPage({
  ...
  const [activeTab, setActiveTab] = useState<'sequencer' | 'program'>('program');
